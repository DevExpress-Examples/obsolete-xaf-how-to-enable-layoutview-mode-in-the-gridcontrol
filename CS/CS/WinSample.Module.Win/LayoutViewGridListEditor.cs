...
namespace WinSample.Module.Win {
    public class XafLayotView : LayoutView {
    ...
    public class LayoutViewGridListEditor : ListEditor, IControlOrderProvider, IDXPopupMenuHolder, IComplexListEditor, IPrintableSource, ILookupListEditor {
        ...
        private XafLayotView layoutView;
        ...
        private XafLayotView CreateLayotView() {
            layoutView = new XafLayotView();
        ...
        public XafLayotView LayoutView {
