...
Namespace WinSample.Win
	Partial Public Class WinSampleWindowsFormsApplication
		...
		Private Sub InitializeComponent()
			...
			' oleDbConnection1
			' 
			Me.oleDbConnection1.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Password=;User ID=Admin;Data Source=WinSample.mdb;Mode=Share Deny None;"
			' 
			' WinSampleWindowsFormsApplication
			' 
			Me.ApplicationName = "WinSample"
			Me.Connection = Me.oleDbConnection1
			Me.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Password=;User ID=Admin;Data Source=WinSample.mdb;Mode=Share Deny None;"
